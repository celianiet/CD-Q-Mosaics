...
<?php 
  if(isset($_POST['email'])){
	...
	<tr>
	<td colspan='2' align='center' valign='top'><img style='margin-top: 15px; width:200px;' src='http://cdqmosaicos.com/images/vimages/logo-down.png' ></td>
	</tr>
	<tr>
